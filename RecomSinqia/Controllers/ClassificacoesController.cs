...
namespace RecomSinqia.Controllers
{
    public class ClassificacoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nome,Sigla")] Classificacao classificacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nome,Sigla")] Classificacao classificacao)
        {
            if (ModelState.IsValid)
            {
